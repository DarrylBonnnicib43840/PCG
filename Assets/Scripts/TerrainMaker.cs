...
public class TerrainMaker : MonoBehaviour
{
	...
	void AddWind(){
			...
			Instantiate(windzone, new Vector3(71,354,0),Quaternion.identity);
			windzone.name = "wind";
	...
	void AddRain(){
		...
		Instantiate(rainzone, new Vector3(71,354,0),Quaternion.identity);
			rainzone.name = "rain";
	}
